...
-find way to keep program running, updating list:
	...
	-this would neccessitate a "Quit Program" functionality
-need to control user inputs throughout program, force lowercase etc.
"""
