...
while str(game) != '9':
	...
	river = []
	deck = {
	1:["",'cA','c2','c3','c4','c5','c6','c7','c8','c9','c10','cJ','cQ','cK'],
	2:["",'sA','s2','s3','s4','s5','s6','s7','s8','s9','s10','sJ','sQ','sK'],
	3:["",'dA','d2','d3','d4','d5','d6','d7','d8','d9','d10','dJ','dQ','dK'],
	4:["",'hA','h2','h3','h4','h5','h6','h7','h8','h9','h10','hJ','hQ','hK']
	}
